...
nmap_leader('bo', delete_other_buffers,                          'Delete other buffers')
...
nmap_leader('dB', '<Cmd>lua require("dap").clear_breakpoints()<CR>', 'Clear breakpoints')
...
nmap_leader('du', '<Cmd>lua require("dap-view").toggle()<CR>',       'Toggle UI')
-- stylua: ignore end
